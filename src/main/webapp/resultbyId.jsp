...
<div class="page">
    ...
    <section>
        <button style="background-color: #3498db;border: 1px solid black;border-radius: 2px;"><a href="Vueusers.jsp" style="color: white;text-decoration: none">Back</a></button>
        ...
        <table style="width: 100%">
            ...
            <%
                String id= (String) request.getAttribute("userbyid");
                System.out.println(id);
                Users users= DBuser.search(id);
